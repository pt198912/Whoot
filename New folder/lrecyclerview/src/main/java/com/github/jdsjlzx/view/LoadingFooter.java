...
public class LoadingFooter extends RelativeLayout implements ILoadMoreFooter{
    ...
    private LinearLayout footer_end;
    ...
    public void setState(State status, boolean showView) {
        ...
        switch (status) {
            ...
            case NoMore:
                ...
                if (mTheEndView == null) {
                    ViewStub viewStub = (ViewStub) findViewById(R.id.end_viewstub);  //R.id.end_viewstub
                    mTheEndView = viewStub.inflate();
                   /* mTheEndView=inflate(getContext(),R.layout.layout_recyclerview_footer_end,this);
                    footer_end = (LinearLayout)mTheEndView.findViewById(R.id.footer_end);
                    mNoMoreText = (TextView) mTheEndView.findViewById(R.id.loading_end_text);*/
                } else {
                  //  footer_end.setVisibility(VISIBLE);
