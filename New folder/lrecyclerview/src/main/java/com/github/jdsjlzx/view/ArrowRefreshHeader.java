...
public class ArrowRefreshHeader extends LinearLayout implements IRefreshHeader {
    ...
    private void initView() {
        ...
        hahh = (ImageView)findViewById(R.id.hahh);
        mAnimDrawable = (AnimationDrawable)hahh.getDrawable();
    ...
    public void setState(int state) {
        ...
        if (state == STATE_REFRESHING) {	// 显示进度
           // mArrowImageView.clearAnimation();
            ...
            hahh.setVisibility(VISIBLE);
            mAnimDrawable.start();
            smoothScrollTo(mMeasuredHeight);
        } else if(state == STATE_DONE) {
//            mArrowImageView.setVisibility(View.INVISIBLE);
            mProgressBar.setVisibility(View.GONE);
            hahh.setVisibility(GONE);
...
//        ScrollTo(0);
    ...
    private void ScrollTo(int destHeight) {
