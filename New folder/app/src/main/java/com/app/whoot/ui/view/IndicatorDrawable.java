...
public class IndicatorDrawable extends Drawable {
    private static final int INDICATOR_MARGIN = ScreenUtils.dp2px(MyApplication.getInstance(),12);
    private static final int INDICATOR_HEIGHT = ScreenUtils.dp2px(MyApplication.getInstance(),3);
    private static final int INDICATOR_RADIUS = ScreenUtils.dp2px(MyApplication.getInstance(),1.5f);
    ...
    public IndicatorDrawable(View view) {
        ...
        paint.setColor(view.getContext().getResources().getColor(R.color.main_gold));
    }
