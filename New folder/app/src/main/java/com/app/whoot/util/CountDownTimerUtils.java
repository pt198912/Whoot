...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setText(  context.getResources().getString(R.string.resend)+millisUntilFinished / 1000+context.getResources().getString(R.string.sends));  //设置倒计时时间
        mTextView.setBackgroundResource(R.drawable.login_btn_one); //设置按钮为灰色，这时是不能点击的
    ...
    public void onFinish() {
        mTextView.setText(context.getResources().getString(R.string.rleaend));
        mTextView.setClickable(true);//重新获得点击
        mTextView.setBackgroundResource(R.drawable.login_btn_one);  //还原背景色
        mTextView.getBackground().setAlpha(255);
        StopTime=true;

    }
    public boolean OnStopTime(){
