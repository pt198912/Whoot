...
public class ShopsLVAdapter extends BaseAdapter {
    ...
    public ShopsLVAdapter(Context context, List<CardBean> list) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.item_hera, null);
            hodler.item_hera_txview=(TextView)view.findViewById(R.id.item_hera_txview);
            hodler.item_hera_text=(TextView)view.findViewById(R.id.item_hera_text);
            hodler.item_hera_title=(TextView)view.findViewById(R.id.item_hera_title);
            hodler.item_hera_z=(TextView)view.findViewById(R.id.item_hera_z);
            hodler.item_hera_zx=(TextView)view.findViewById(R.id.item_hera_zx);
            hodler.item_hera_tz=(TextView)view.findViewById(R.id.item_hera_tz);
            hodler.item_hera_img0=(ImageView)view.findViewById(R.id.item_hera_img0);
            hodler.item_hera_img1=(ImageView)view.findViewById(R.id.item_hera_img1);
            hodler.item_hera_img2=(ImageView)view.findViewById(R.id.item_hera_img2);
            hodler.item_hera_img3=(ImageView)view.findViewById(R.id.item_hera_img3);
            hodler.item_hera_img4=(ImageView)view.findViewById(R.id.item_hera_img4);
            hodler.item_hera_round=(RoundImageView)view.findViewById(R.id.item_hera_round);
            hodler.item_hera_ly=(LinearLayout)view.findViewById(R.id.item_hera_ly);
            hodler.store_item_name =view.findViewById(R.id.store_item_name);
            hodler.store_item_token =view.findViewById(R.id.store_item_token);
            hodler.store_item_num = view.findViewById(R.id.store_item_num);
            hodler.image_recycler = (RecyclerView)view.findViewById(R.id.image_recycler);
            view.setTag(hodler);
        } else {
        ...
        try{String timeFormatZx = TimeUtil.timedateone(Long.parseLong(list.get(position).getUpdateTm()));
...
//                        DishReviewAdapter.mCurrentShopLvAdapter=ShopsLVAdapter.this;
