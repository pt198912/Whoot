...
import com.app.whoot.modle.window.dialog.CommonDialog;
import com.app.whoot.modle.window.dialog.CommonDialogFragment;
                                ...
                                holder.setText(R.id.tv_window, arrayData[0])
                                        ...
                                        .setOnClickListener(R.id.bt_window, new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                ToastUtil.showgravity(context, arrayData[2]);
                                            }
                                        });
                            }
                        })//布局ID
