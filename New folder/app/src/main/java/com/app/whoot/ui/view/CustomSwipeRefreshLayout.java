...
*/
    ...
    /**
     * Classes that wish to override {@link CustomSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link CustomSwipeRefreshLayout#canChildScrollUp()} method
        ...
        /**
         * Callback that will be called when {@link CustomSwipeRefreshLayout#canChildScrollDown()} method
         * is called to allow the implementer to override its behavior.
         *
         * @param parent SwipeRefreshLayout that this callback is overriding.
         * @param child  The child view of SwipeRefreshLayout.
         ...
         */
        boolean canChildScrollDown(@NonNull CustomSwipeRefreshLayout parent, @Nullable View child);
    }
