...
public class RoundProgressBar extends View {
    ...
    private void init() {
        paint = new Paint();
        roundColor = 0x00000000;
        roundProgressColor = 0xff67E5B3;
        textColor = 0xff00ff00;
        textSize = 15;
        roundWidth = ScreenUtils.dp2px(getContext(),4.5f);
        max = 100;
        textIsDisplayable = true;
        style = 0;
//        setLayerType(LAYER_TYPE_SOFTWARE,null);
//        paint.setMaskFilter(new BlurMaskFilter(roundWidth, BlurMaskFilter.Blur.SOLID));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        case FILL_UP:
            ...
            if (progress != 0) {
                ...
                canvas.drawArc(oval, angle+90, 360 * progress / max, false, paint);
            }
            break;
        }
