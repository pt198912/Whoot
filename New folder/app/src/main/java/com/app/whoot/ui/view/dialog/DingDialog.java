...
/**
 * Created by Sunrise on 7/18/2018.
 */
...
public class DingDialog extends Dialog {
    ...
    public DingDialog(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public DingDialog create() {
            ...
            final DingDialog dialog = new DingDialog(context, R.style.Dialog);
            View layout = inflater.inflate(R.layout.dingdiglog, null);
            //设置点击对话框外不消失
