...
public class GiftReTweDialog extends Dialog {
    /**
     * 上下文对象 *
     */
    Activity context;
    ...
    public GiftReTweDialog(Activity context) {
        super(context);
        this.context = context;
    }

    public GiftReTweDialog(Activity context, int theme, View.OnClickListener clickListener) {
        super(context, theme);
        this.context = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 指定布局
        this.setContentView(R.layout.gift_twe_dialog);
