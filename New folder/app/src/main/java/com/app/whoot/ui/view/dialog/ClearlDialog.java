...
public class ClearlDialog extends Dialog {
    ...
    public ClearlDialog(Activity context) {
        super(context);
        this.context = context;
    }

    public ClearlDialog(Activity context, int theme) {
        super(context, theme);
        this.context = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 指定布局
        this.setContentView(R.layout.cleardialog);


        TextView clear_txt = findViewById(R.id.clear_txt);
        ...
        String creaDia = (String) SPUtil.get(context, "creaDia", "");
        if (creaDia.equals("1")){
            clear_txt.setText(context.getResources().getString(R.string.pro_saved));
        }
        // 为按钮绑定点击事件监听器
