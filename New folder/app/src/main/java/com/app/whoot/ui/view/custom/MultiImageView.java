...
import com.app.whoot.util.DisplayUtils;
...
public class MultiImageView extends LinearLayout {
    ...
    private View createImageView(int position, final boolean isMultiImage) {
        ...
        Glide.with(getContext()).load(url).placeholder(R.drawable.storedetail_top5_blank_pic).error(R.drawable.storedetail_top5_blank_pic)
