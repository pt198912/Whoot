...
public class CustomRefreshHeader extends InternalClassics<com.scwang.smartrefresh.layout.header.ClassicsHeader> implements RefreshHeader {
...
//        centerLayout.addView(updateView, lpUpdateText);
        ...
        mAnimDrawable=(AnimationDrawable)mProgressView.getDrawable();
...
//    }
    ...
    public int onFinish(@NonNull RefreshLayout layout, boolean success) {
        if (success) {
            mTitleText.setText(com.github.jdsjlzx.R.string.refresh_done);
            if (mLastTime != null) {
                setLastUpdateTime(new Date());
            }
        } else {
    ...
    public void onStateChanged(@NonNull RefreshLayout refreshLayout, @NonNull RefreshState oldState, @NonNull RefreshState newState) {
        ...
        switch (newState) {
            ...
            case PullDownToRefresh:
                mTitleText.setText(com.github.jdsjlzx.R.string.listview_header_hint_normal);
                arrowView.setVisibility(VISIBLE);
//                arrowView.animate().rotation(0);
                break;
            case Refreshing:
            case RefreshReleased:
                mTitleText.setText(com.github.jdsjlzx.R.string.refreshing);
                arrowView.setVisibility(GONE);

                break;
            case ReleaseToRefresh:
                mTitleText.setText(com.github.jdsjlzx.R.string.listview_header_hint_release);
...
//                arrowView.animate().rotation(0);
    ...
    public com.scwang.smartrefresh.layout.header.ClassicsHeader setAccentColor(@ColorInt int accentColor) {
