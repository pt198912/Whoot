...
public class PullToRefreshView extends LinearLayout {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			//	headerPrepareToRefresh(deltaY);           阻止下拉刷新
				// setHeaderPadding(-mHeaderViewHeight);
			} else if (mPullState == PULL_UP_STATE) {// 执行上拉
			//	footerPrepareToRefresh(deltaY);       //阻止上拉
			}
			mLastMotionY = y;
			break;
		case MotionEvent.ACTION_UP:
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			mHeaderTextView.setText(getResources().getString(R.string.sifang));
			...
			mHeaderImageView.startAnimation(mFlipAnimation);
			// mHeaderImageView.
			mHeaderTextView.setText(getResources().getString(R.string.xiala));
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
			...
			mFooterTextView.setText(getResources().getString(R.string.songkai));
			...
			mFooterImageView.clearAnimation();
			mFooterImageView.startAnimation(mFlipAnimation);
			mFooterTextView.setText(getResources().getString(R.string.shangla));
	...
	private void headerRefreshing() {
		...
		mHeaderTextView.setText(getResources().getString(R.string.zhengzai));
	...
	private void footerRefreshing() {
		...
		mFooterTextView.setText(getResources().getString(R.string.jiazai));
